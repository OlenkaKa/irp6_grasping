...
private:
  ...
  static geometry_msgs::Vector3 quat2rot(const geometry_msgs::Quaternion &quaternion);
  static geometry_msgs::Quaternion rot2quat(const geometry_msgs::Vector3 rpy);
};
